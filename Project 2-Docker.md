...
![[docker_installation_success.png]]
...
![[bookstack_container_creation.png]]
7. Go to your browser and navigate to the URL you specified in your .yml (I used localhost). This will load the login page for Bookstack.
8. The default username is admin@admin.com with the password **password**. This will take you to your home page. 
9. 
![[bookstack_homepage.png]]
